...
using LMYFrameWorkMVC.Web.CommonCode.SignalR;
...
namespace LMYFrameWorkMVC.Web.Areas.Admin.Controllers
{
    public class AccountController : BaseController
    {
        ...
        [HttpGet]
        public ActionResult ChangePassword(BaseModel baseModel)
        {
            ChangePasswordModel changePasswordModel = new ChangePasswordModel();
            changePasswordModel.CopyBaseModel(baseModel);
            changePasswordModel.Id = ContextInfo.UserID;

            //using (BAL.UserBAL userBAL = new BAL.UserBAL(ContextInfo))
            //{
            //    userBAL.PrepareUserModel(userModel, true);
            //}
        ...
        public ActionResult ChangePassword(ChangePasswordModel changePasswordModel)
        {
            using (UserBAL userBAL = new UserBAL(ContextInfo))
            {
                if (ModelState.IsValid)
                {
                    userBAL.ChangePassword(changePasswordModel);
                }
            }

            if (changePasswordModel.HasErrorByType(LMYFrameWorkMVC.Common.LookUps.ErrorType.Critical) || changePasswordModel.HasSuccess(LMYFrameWorkMVC.Common.LookUps.SuccessType.Full))
            {  
                return base.RedirectToActionWithData(new Dictionary<string, object> { { "baseModel", changePasswordModel } }, "ChangePassword", "Account");
            }
