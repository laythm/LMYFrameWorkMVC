...
{
    public partial class AspNetUser : IAuditedDatesEntity, IAuditedUsersEntity, IAuditWrapper, ICacheClear
    {
        ...
        {
            Common.Helpers.CacheHelper.RemoveCache(new CacheMemberKey() { CacheKey = LookUps.CacheKeys.UsersRoles, ObjectId = this.Id });
        }
    }
}
